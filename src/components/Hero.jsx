...
const slides = [
  {
   ...
   {
    type: "normal",
    title: "Web Foundations – Front-End Skills",
  ...
  {
    type: "normal",
    title: "What You Will Learn in This Workshop",
...
export default function HeroSection() {
  ...
  return (
    <div className="relative overflow-hidden bg-white pt-[100px] sm:pt-20 lg:pt-32 pb-16 sm:pb-20 lg:pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Slider Arrows */}
        <div className="absolute inset-y-0 left-0 right-0 flex items-center justify-between px-4 pointer-events-none">
          <button
            onClick={prevSlide}
            className="pointer-events-auto bg-white shadow-md hover:bg-gray-100 p-2 sm:p-3 rounded-full"
          >
     ...
     <div className="grid md:grid-cols-1 lg:grid-cols-2 gap-12 items-start lg:items-start">
  {slides[current].type === "custom" ? (
    ...
    <>
      ...
      <motion.div
        ...
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.6 }}
        className="flex justify-center lg:justify-end items-center" // vertical center
      >
        <img
